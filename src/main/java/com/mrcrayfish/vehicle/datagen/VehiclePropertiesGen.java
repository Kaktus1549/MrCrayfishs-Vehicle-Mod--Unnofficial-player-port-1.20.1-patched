...
public class VehiclePropertiesGen extends VehiclePropertiesProvider
{
    ...
    public void registerProperties()
    {
        ...
        this.add(ModEntities.ALUMINUM_BOAT.get(), VehicleProperties.builder()
                ...
                //.setFuelPortTr(PartPosition.create(-16.0, 3.0, -18.0, 0.0, -90.0, 0.0, 0.25))
                .setDisplayTransform(Transform.create(1.0))
        ...
        this.add(ModEntities.MINI_BIKE.get(), VehicleProperties.builder()
                ...
                //.setEngine(PartPosition.create(0.0, 1.0, 2.5, 0.0, 180.0, 0.0, 0.7))
...
//                .setFrontAxleOffset(13)
        ...
        this.add(ModEntities.SMART_CAR.get(), VehicleProperties.builder()
                .setAxleOffset(-1.7F)
                .setBodyTransform(Transform.create(1.25))
                //.setFuelPortTra(PartPosition.create(-9.0, 8.7, -12.3, 0, -90, 0, 0.25))
                ...
                .addWheel(Wheel.builder()
                        ...
                        .addExtended(PoweredProperties.builder()
                                ...
                                .setEngineType(EngineType.ELECTRIC_MOTOR).build()
                                //.setCanChangeWheels(true)
                                //.setColored(true));
                        )
...
//                        .addModelLocation(VehicleModels.SPORTS_CAR_HOOD.getModelLocation())
...
//                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.LEFT_DOOR)
//                        .addModelLocation(VehicleModels.SPORTS_CAR_LEFT_DOOR.getModelLocation())
//                        .setOffset(15.0, 1.0, 10.0)
//                        .addAction(new OpenableAction(Axis.Y, -75F, new ResourceLocation("vehicle:entity.vehicle.door.open"), new ResourceLocation("vehicle:entity.vehicle.door.close"), 12)))
//                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.RIGHT_DOOR)
//                        .addModelLocation(VehicleModels.SPORTS_CAR_RIGHT_DOOR.getModelLocation())
//                        .setOffset(-15.0, 1.0, 10.0)
...
//                        .addModelLocation(VehicleModels.SPORTS_CAR_BOOT.getModelLocation())
...
//                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.SEAT)
//                        .addModelLocation(VehicleModels.SPORTS_CAR_SEAT.getModelLocation())
//                        .setOffset(0, 1.0, 0))
//                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.DASHBOARD)
//                        .addModelLocation(VehicleModels.SPORTS_CAR_DASHBOARD.getModelLocation())
//                        .setOffset(0, 14.0, 12.0))
//                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.ROOF)
//                        .addModelLocation(VehicleModels.SPORTS_CAR_ROOF.getModelLocation())
//                        .setOffset(0, 14.0, 0)));
        ...
        this.add(ModEntities.SPORTS_PLANE.get(), VehicleProperties.builder()
                ...
                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.WINGS)
                        .addModelLocation(VehicleModels.SPORTS_PLANE_RIGHT_WING.getModelLocation())
                        .setOffset(0, 20, -7)
                        .build())

                .addCosmetic(CosmeticProperties.builder(StandardCosmetics.WINGS)
                        .addModelLocation(VehicleModels.SPORTS_PLANE_LEFT_WING.getModelLocation())
                        .setOffset(0, 20, -7)
                        .build())
